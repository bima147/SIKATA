...
public interface LocationRepo extends JpaRepository<Location,Long> {
    List<Location> findByCreatedBy(Long createdBy);
    Page<Location> findByLocationID(Pageable pageable, String locationID);
    Page<Location> findByProvinceContainingIgnoreCase(Pageable pageable, String province);
}
